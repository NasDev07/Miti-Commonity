...
<head>
    ...
    <title>Miti Community | @yield('title')</title>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item @if (isset($menuProduk)) {{ $menuProduk }} @endif">
                        <a href="{{ route('produk.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user-circle"></i>
                            <div data-i18n="Account Settings">Gambar</div>
                        </a>
                    </li>
                    <li class="menu-item @if (isset($menuPakai)) {{ $menuPakai }}@endif">
                        <a href="{{route('pemakaian.index')}}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-user-circle"></i>
                            <div data-i18n="Account Settings">Pertanyaan</div>
                        </a>
                    </li>
                    @endif
                    {{-- @endcan --}}
